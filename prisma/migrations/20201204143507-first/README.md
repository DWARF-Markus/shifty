# Migration `20201204143507-first`

This migration has been generated by DWARF-Markus at 12/4/2020, 3:35:07 PM.
...
ALTER TABLE "CompanyShiftEmployee" ADD FOREIGN KEY("companyShiftId")REFERENCES "Employee"("id") ON DELETE SET NULL ON UPDATE CASCADE
